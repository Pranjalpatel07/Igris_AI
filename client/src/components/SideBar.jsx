...
import { addConversation, setConversation, setSelectConversation} from '../redux/conversationSlice'
            ...
            <div className='relative shrink-0'>
                {
                    (userData?.avatar && !imageError)
                        ...
                        : 
                        <div className='w-9 h-9 rounded-[10px] bg-white/6 flex items-center justify-center'><User size={15} className='text-slate-400'/></div>
                }
            </div>
                ...
                {userData ? (
                    <div className='flex items-center gap-2.5 cursor-pointer rounded-xl px-3 py-2.5 hover:bg-white/5 transition-colors duration-150'>
                        ...
                        <div className='flex gap-1'>
                            ...
                            <button className='flex items-center justify-center w-7 h-7 rounded-[7px] border-none bg-transparent text-slate-600 cursor-pointer hover:bg-white/8 hover:text-slate-400 transition-all duration-150' onClick={()=>{
                                logout();
